...
+ dl_tree_({ ctx, _: sticky__dl_tree_props_ }, ()=>[
    ...
    `- enhance cognitive function`,
		``,
    `Making it a valuable tool for mental health management.`].join(nl)],
