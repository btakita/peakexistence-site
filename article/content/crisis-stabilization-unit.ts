...
+ dl_tree_({ ctx, _: sticky__dl_tree_props_ }, ()=>[
	...
	[`## Services Offered${mobile_hidden__span_([` by Crisis Stabilization Units`])}`, [
		...
		()=>[
			...
			[`### Medication Management`, [
				`Adjustment of existing medications or starting new ones as needed.`].join(nl)],
			[`### Individual & Group Therapy`, [
				`Support groups & therapeutic sessions tailored towards crisis management.`].join(nl)],
			[`### Skill-Building`, [
	...
	[`## Who Can Benefit?`, [
		...
		()=>[
			...
			[`### Community-Based`, [
				`Individuals remain connected to their usual support system with less disruption.`].join(nl)],
			[`### Cost-Effective`, [
				`Typically less expensive than hospitalization.`].join(nl)],
			[`### Preventative Focus`, [
    ...
    `- a pathway to continued care`,
		``,
    `As the demand for mental health services continues to grow. Crisis Stabilization Units become even more pivotal. In meeting the needs of communities across the nation${footnote__sup__sort([ref_c1_1_footnote__sup_(ctx),ref_c1_2_footnote__sup_(ctx),ref_c1_3_footnote__sup_(ctx)])}.`].join(nl)],
])
// @formatter:on
