...
+ dl_tree_({ ctx }, [
	...
	[`## How It Works`, [
		`During the procedure, you'll lie on a scanning table that slides through the machine. The machine rotates around you, capturing numerous X-ray images.  A computer then processes these images to create detailed cross-sections of your body, allowing doctors to examine your organs, bones, and blood vessels for potential issues. The entire process is swift, often concluding within mere minutes.`].join(nl)],
	[`## The Benefits`, [
		...
		`3. Non-Invasive: Simple and straightforward, the scan requires no incisions or extended hospital stays.`].join(nl)],
	...
	[`## Considerations`, [
		...
		`| Provides peace of mind                    | Accessibility and cost may be prohibitive for some  |`].join(nl)],
