...
1. The patient lies down.
2. The skin gets cleaned.
3. A needle is guided to the nerve's location.
4. Medicine is injected.

It's quick. Patients often go home the same day.
...
- Diagnostic tool: Can help pinpoint the source of chronic pain.

## Risks

- Infection.
- Bleeding.
- Rarely, lung puncture.
...
Remember, this procedure is a tool. It's part of a broader pain management strategy. Always consider the full spectrum of your health needs.
`)
// @formatter:on
