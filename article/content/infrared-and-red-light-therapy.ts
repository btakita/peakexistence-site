...
+ dl_tree_({ ctx }, [
	[`## What are Infrared & Red Light Therapy?`, [
		...
		`- pain management`,
		``,
		`PBM accelerates recovery and relieve symptoms without invasive procedures.`].join(nl)],
	[`## How They Work`, [
		dl_tree_({ ctx }, [
			[`### Red Light Therapy (RLT)`, [
				`Utilizes wavelengths of red light, ranging from 630 to 700 nanometers (nm). It's effective for surface-level skin treatments, enhancing collagen production, and reducing inflammation.`].join(nl)],
			[`### Infrared Therapy`, [
	...
	[`## Benefits Unveiled`, [
		dl_tree_({ ctx }, [
			[`### Skin Rejuvenation`, [
				`Promotes collagen production, reducing wrinkles and improving skin tone.`].join(nl)],
			[`### Pain Relief`, [
				`Eases joint and muscle pain by reducing inflammation and increasing circulation.`].join(nl)],
			[`### Improved Muscle Recovery`, [
				`Accelerates the healing process in muscles, making it popular among athletes.`].join(nl)],
			[`### Enhanced Circulation`, [
				`Boosts blood flow, delivering more oxygen and nutrients to tissues.`].join(nl)],
			[`### Mood Enhancement`, [
				`Exposure to red and infrared light can improve mood and energy. By increasing serotonin levels.`].join(nl)],
		])].join(nl)],
	[`## Considerations`, [
		`| **Pros**                                        | **Cons**                                                |`,
		`|:------------------------------------------------|:--------------------------------------------------------|`,
	...
	[`## Getting Started`, [
		...
		`3. **Trial Sessions:** Start with a few sessions to see how your body responds.`].join(nl)],
	[`## Conclusion`, [
