...
+ dl_tree_({ ctx }, [
	...
	[`## Improved Stamina and Endurance`, [
		`By increasing oxygen intake during exercise, EWOT helps you push your boundaries. Leading to improved stamina and endurance over time.`].join(nl)],
	...
	[`## Cardiovascular Health`, [
		`Increased oxygen levels support heart health, improving blood flow and circulation.`].join(nl)],
	[`## Detoxification`, [
		`Oxygen is essential for cellular detoxification. Helping to remove waste and improve cellular health.`].join(nl)],
	[`## Boosted Mental Clarity`, [
		`Improved oxygenation improves cognitive function. Promoting better focus and mental clarity.`].join(nl)],
