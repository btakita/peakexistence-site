...
+ dl_tree_({ ctx, _: sticky_h2__dl_tree_props_ }, ()=>[
	...
	[`## Benefits of EWOT`, [
		()=>[
			[`### Improved Exercise Performance`, [
				`Studies have shown that EWOT enhances physical performance by increasing endurance & reducing fatigue. This is particularly beneficial for athletes & individuals engaged in high-intensity workouts${footnote__sup__sort([ref_e1_3_footnote__sup_(ctx),ref_e1_11_footnote__sup_(ctx)])}.`,]],
			[`### Accelerated Recovery`, [
				`Oxygen plays a crucial role in recovery processes. Including the repair of muscle tissue & the reduction of inflammation. EWOT can help speed up these recovery mechanisms. Allowing for quicker restoration of muscle function & reduced soreness after exercise${footnote__sup__sort([ref_e1_3_footnote__sup_(ctx),ref_e1_11_footnote__sup_(ctx)])}. Giving you more frequent & effective exercise.`,]],
			...
			[`### Detoxification`, [
				`Oxygen is essential for cellular detoxification. Helping to remove waste & improve cellular health.`,]],
	...
	[`## Implementing EWOT`, [
		`Individuals typically use an oxygen concentrator. Connected to a mask or nasal cannula during exercise sessions. It is important to start with moderate intensities to assess tolerance. Increasing the duration & intensity of workouts under the guidance of a healthcare professional.`,]],
	[`## Conclusion`, [
	...
	[`## Why Choose Dr. ${mobile_hidden__span_([`Manny `])}Emenike${mobile_hidden__span_([` for EWOT`])}?`, [
		...
		nl,
		`Exercise with Oxygen Therapy (EWOT) is a safe & efficient method. To improve oxygen circulation in the body & promote overall health & wellness. With overwhelming benefits & faster results compared to other oxygen therapies. EWOT is an accessible & effective option. For individuals seeking to optimize their health & vitality.`,]],
])
// @formatter:on
function ref_e1_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		...
		tb_a_({
			href: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8885311/',
			nofollow: true,
			wrap: true,
...
function ref_e1_2_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		...
		tb_a_({
			href: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2866201/',
			nofollow: true,
			wrap: true,
...
function ref_e1_3_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		...
		tb_a_({
			href: 'https://www.onethousandroads.com/blogs/ewot-blog/the-benefits-of-exercise-with-oxygen-therapy-ewot',
			nofollow: true,
			wrap: true,
...
function ref_e1_7_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		...
		tb_a_({
			href: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3651238/',
			nofollow: true,
			wrap: true,
...
function ref_e1_8_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		...
		tb_a_({
			href: 'https://www.onethousandroads.com/blogs/ewot-blog/exercise-with-oxygen-therapy-the-ultimate-guide',
			nofollow: true,
			wrap: true,
		}, 'Your Guide to Exercise with Oxygen Therapy')
	])
}
function ref_e1_9_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'e1_9'
	}, [
		tb_a_({
			href: 'https://regenmed.io/services/ewot-exercise-with-oxygen-therapy/',
			nofollow: true,
			wrap: true,
		}, 'Exercise with Oxygen Therapy (EWOT)')
	])
}
function ref_e1_10_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'e1_10'
	}, [
		tb_a_({
			href: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10662626/',
			nofollow: true,
			wrap: true,
...
function ref_e1_11_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'e1_11'
	}, [
		tb_a_({
			href: 'https://physmedcolumbus.com/patients/patient-education/68-ewot-exercise-with-oxygen-therapy-benefits-and-uses',
			nofollow: true,
			wrap: true,
		}, 'EWOT (Exercise with Oxygen Therapy) Benefits and Uses')
	])
}
function ref_e1_15_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'e1_15'
	}, [
		tb_a_({
			href: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8650584/',
			nofollow: true,
			wrap: true,
...
function ref_e1_17_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'e1_17'
	}, [
		tb_a_({
			href: 'https://www.frontiersin.org/articles/10.3389/fnagi.2024.1340117/full',
			nofollow: true,
			wrap: true,
		}, 'Enriched oxygen improves age-related cognitive impairment through enhancing autophagy')
	])
}
function ref_e1_19_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'e1_19'
	}, [
		tb_a_({
			href: 'https://openres.ersjournals.com/content/5/3/00118-2019',
			nofollow: true,
			wrap: true,
