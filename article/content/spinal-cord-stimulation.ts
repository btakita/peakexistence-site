...
+	dl_tree_({ ctx }, [
	...
	[`## The SCS Procedure`, [
		...
		dl_tree_({ ctx }, [
			[`### Evaluation`, [
				`A thorough assessment with a pain specialist determines if SCS is a suitable option. This includes medical history, physical exam, imaging, and often a psychological evaluation.`].join(nl)],
			[`### Trial Period`, [
				`Before permanent implantation, a temporary trial is conducted. Connecting leads without surgical incision to an external generator worn on a belt. To test the effectiveness of the device. Success is usually defined as a 50% or greater reduction in pain. This trial phase lasts about a week. Allowing the patient & doctor to evaluate the effectiveness of the stimulation settings. Gauging how well you respond to the therapy.`].join(nl)],
			[`### Permanent Implantation`, [
				`If the trial is successful, a permanent device is implanted. Through a minimally invasive surgical procedure. To implant the generator and tunnel the leads to their final position.`].join(nl)],
			[`### Programming & Optimization`, [
				`Your doctor works with you to find the optimal stimulation settings. That provide the best pain relief & minimize any side effects. Adjusting the device's settings according your pain management needs over time.`].join(nl)],
		])].join(nl)],
	[`## Applications for Spinal Cord Stimulation`, [
		...
		dl_tree_({ ctx }, [
			...
			[`### Complex Regional Pain Syndrome (CRPS)`, [
				`A chronic condition affecting a limb. Usually after injury, causing burning pain, swelling, and skin changes.`].join(nl)],
			[`### Peripheral Neuropathy`, [
				`Nerve damage often in the legs and feet due to conditions like diabetes or chemotherapy.`].join(nl)],
			[`### Radiculopathy`, [
				`Pain radiating down the leg due to a compressed spinal nerve root.`].join(nl)],
			[`### Arachnoiditis`, [
				`Inflammation and scarring of the protective layers of the spinal nerves.`].join(nl)],
			[`### Failed Back Surgery Syndrome (FBSS)`, [
				`Persistent pain following one or more spine surgeries. Also known as post-laminectomy syndrome.`].join(nl)],
	...
	[`## The Future of Spinal Cord Stimulation`, [
		...
		dl_tree_({ ctx }, [
			[`### Improving Modulation Protocols`, [
				...
				``,
				`The use of improved modulation protocols with existing devices. Depends on the specific device & it's capabilities. Newer SCS systems are programmable & adaptable. Allowing for updates and the use of novel waveforms${footnote__sup__sort([ref1_2_footnote__sup_(ctx),ref1_3_footnote__sup_(ctx)])}. For instance, devices that include feature capabilities can include these modulation adjustments${ref1_9_footnote__sup_(ctx)}:`,
			...
			[`### SCS for Other Conditions`, [
				dl_tree_({ ctx }, [
					[`#### Refractory Angina`, [
						`Research indicates SCS as an effective & safe treatment option. With clinical trials and systematic reviews demonstrating its efficacy in providing${footnote__sup__sort([ref2_1_footnote__sup_(ctx),ref2_2_footnote__sup_(ctx),ref2_3_footnote__sup_(ctx),ref2_5_footnote__sup_(ctx),ref2_7_footnote__sup_(ctx),ref2_8_footnote__sup_(ctx),ref2_13_footnote__sup_(ctx),ref2_15_footnote__sup_(ctx)])}:`,
						`- symptomatic relief`,
						`- functional status improvement`,
						`- enhanced quality of life for patient`,
						``,
						`Authoritative institutions have recognized SCS as a therapeutic alternative for refractory angina. With class IIb recommendations${footnote__sup__sort([ref2_1_footnote__sup_(ctx),ref2_2_footnote__sup_(ctx)])}:`,
	...
	[`## Conclusion`, [
		`Spinal Cord Stimulation represents a significant development in the field of pain management. Particularly for patients with chronic pain conditions unresponsive to other treatments. The therapy continues to provide relief for many patients. While some recent studies question its long-term efficacy. As with any medical intervention. Have thorough evaluation & discussion of potential risks & benefits with a healthcare provider. To determine if SCS is an appropriate treatment option.`].join(nl)],
])
// @formatter:on
