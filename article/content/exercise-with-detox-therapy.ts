	...
	[`## Benefits of Exercise with Detox Therapy`, [
		()=>[
			...
			[`### Improved Circulation`, [
				`Exercise increases blood flow. Which is crucial for transporting nutrients to cells & removing waste products. Enhanced circulation during detox helps the body process & eliminate toxins${footnote__sup__sort([ref_e1_1_footnote__sup_(ctx),ref_e1_3_footnote__sup_(ctx)])}.`].join(nl)],
			[`### Boosted Lymphatic System`, [
				`The lymphatic system plays a vital role in immune function & the removal of toxins. Physical activity, especially low-impact exercises like yoga & Tai Chi, supports lymphatic function. Aiding in the detoxification process${ref_e1_4_footnote__sup_(ctx)}.`].join(nl)],
			[`### Enhanced Mental Health`, [
				`Exercise is well-known for its positive effects on mental health. Reducing symptoms of stress, anxiety, & depression. When incorporated into detox therapy, it can provide a psychological boost. Making the detox process more manageable & improving mental well-being${ref_e1_8_footnote__sup_(ctx)}.`].join(nl)],
			...
			[`### Strengthened Immune System`, [
				`Both exercise and detox therapy can strengthen the immune system. Exercise promotes the production of antibodies & white blood cells. While detox therapy helps reduce the burden of toxins that can compromise immune function${footnote__sup__sort([ref_e1_1_footnote__sup_(ctx),ref_e1_3_footnote__sup_(ctx)])}.`].join(nl)],
			[`### Weight Management`, [
