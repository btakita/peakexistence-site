...
+ dl_tree_({ ctx }, [
	[`## Key Benefits of Exercise with Ketamine Infusions`, [
		...
		``,
		`Heightened Mind-Body Connection. Ketamine infusions can enhance mindfulness and promote a stronger mind-body connection during exercise. Helping you stay present and focused on your fitness journey.`].join(nl)],
