...
+ dl_tree_({ ctx, _: sticky_h2__dl_tree_props_ }, ()=>[
	[`## [Aurora ZIP™ Procedure](/articles/aurora-zip-lumbar-fusion)`, [
		...
		()=>[
			...
			[`### Approach`, [
				`Unique expandable implant for fusion with less bone removal.`].join(nl)],
	...
	[`## [Kyphoplasty](/articles/kyphoplasty-spinal-fracture-treatment)`, [
		...
		()=>[
			...
			[`### Approach`, [
				`Balloons to elevate the vertebra followed by bone cement stabilization.`].join(nl)],
	...
	[`## [Percutaneous Spine Decompression](/articles/percutaneous-spine-decompression)`, [
		...
		()=>[
			...
			[`### Approach`, [
				`Removal of tiny amounts of disc or bone to create more space for nerves.`].join(nl)],
	...
	[`## [Spinal Cord Stimulation](/articles/spinal-cord-stimulation)`, [
		...
		()=>[
			...
			[`### Approach`, [
				`The implanted device delivers electrical impulses to help mask pain signals.`].join(nl)],
