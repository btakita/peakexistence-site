...
+ dl_tree_({ ctx, _: sticky__dl_tree_props_ }, ()=>[
	...
	[`## How Does ${mobile_hidden__span_([`Sound Therapy`, `It`])} Work?`, [
		...
		()=>[
			...
			[`### Cellular Resonance`, [
				`The concept is that our cells & organs vibrate at certain frequencies. Positing that external vibrations might promote harmony & balance within the body.`].join(nl)],
	...
	[`## Modalities of Sound Therapy`, [
		...
		()=>[
			...
			[`### Vibroacoustic Therapy`, [
				`Low-frequency vibrations are transmitted to the body. Through speakers embedded in furniture or mats. This method is particularly effective for reducing pain & improving mobility. In conditions like Parkinson's disease & fibromyalgia${footnote__sup__sort([ref_s2_4_footnote__sup_(ctx),ref_s2_10_footnote__sup_(ctx),ref_s1_5_footnote__sup_(ctx)])}.`].join(nl)],
			[`### Music Therapy`, [
				`Led by trained therapists, using music to address emotional, cognitive, or physical needs${footnote__sup__sort([ref_s2_5_footnote__sup_(ctx),ref_s2_9_footnote__sup_(ctx)])}.`].join(nl)],
			[`### Tibetan Singing Bowls`, [
				`These ancient bowls produce rich overtones that promote deep meditation & relaxation${ref_s2_1_footnote__sup_(ctx)}.`].join(nl)],
			[`### Gongs`, [
				`Produce a broad spectrum of sound that stimulates a deep meditative state & relaxation${ref_s2_1_footnote__sup_(ctx)}.`].join(nl)],
	...
	[`## Applications & Benefits`, [
		...
		()=>[
			...
			[`### Improve Sleep`, [
				`The soothing nature of sound therapy can enhance sleep quality. By helping individuals relax & quieten their minds before bedtime. Benefiting those with insomnia or sleep disturbances${ref_s1_1_footnote__sup_(ctx)}.`].join(nl)],
			[`### Emotional Healing`, [
				`Sound therapy facilitates emotional release. Particularly beneficial for those dealing with trauma, grief, or depression. Contributing to greater emotional resilience & well-being${ref_s1_2_footnote__sup_(ctx)}.`].join(nl)],
			[`### Cognitive Function`, [
