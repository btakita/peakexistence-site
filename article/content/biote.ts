...
function ref_b1_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		...
		tb_a_({
			href: 'https://www.drpellicenaobgyn.com/blog/benefits-of-hormone-replacement-therapy-with-biote/',
			nofollow: true,
			wrap: true,
		}, 'Benefits of Hormone Replacement Therapy With BioTE®')
	])
}
function ref_b1_2_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b1_2'
	}, [
		tb_a_({
			href: 'https://mitchellmed.com/5-benefits-of-biote-hormone-therapy/',
			nofollow: true,
			wrap: true,
		}, '5 Benefits of BioTE Hormone Therapy')
	])
}
function ref_b1_3_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b1_3'
	}, [
		tb_a_({
			href: 'https://www.beverlyfischer.net/blog/biote-as-a-breast-cancer-treatment',
			nofollow: true,
			wrap: true,
		}, 'BioTE®: Reduce Your Risk of Breast Cancer')
	])
}
function ref_b1_4_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b1_4'
	}, [
		tb_a_({
			href: 'https://www.plasticsurgerycenterofsacramento.com/non-surgical/wellness/biote-hormone-replacement-therapy/',
			nofollow: true,
			wrap: true,
		}, 'BioTE® Hormone Replacement Therapy')
	])
}
function ref_b1_5_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b1_5'
	}, [
		tb_a_({
			href: 'https://completewomenscare.net/unlocking-hormonal-balance-understanding-the-biote-method/',
			nofollow: true,
			wrap: true,
		}, 'Unlocking Hormonal Balance: Understanding the Biote Method')
	])
}
function ref_b1_5_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b1_5_1'
	}, [
		tb_a_({
			href: 'https://my.clevelandclinic.org/health/treatments/15660-bioidentical-hormones',
			nofollow: true,
			wrap: true,
		}, 'Bioidentical Hormones (Cleveland Clinic)')
	])
}
function ref_b1_6_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b1_6'
	}, [
		tb_a_({
			href: 'https://whatexas.com/blog/how-biote-can-change-your-life/',
			nofollow: true,
			wrap: true,
		}, 'How BioTE Can Change Your Life')
	])
}
function ref_b2_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		...
		tb_a_({
			href: 'https://drbenlight.com/non-surgical/biote-medicals-bioidentical-hormone-optimization/',
			nofollow: true,
			wrap: true,
		}, 'BioTE Medical’s Bioidentical Hormone Optimization')
	])
}
function ref_b2_6_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b2_6'
	}, [
		tb_a_({
			href: 'https://biote.com/clinician-training-certification',
			nofollow: true,
			wrap: true,
		}, 'World Class Training & Certification With Biote')
	])
}
function ref_b2_7_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b2_7'
	}, [
		tb_a_({
			href: 'https://biote.com/men-hormone-imbalance/testimonials',
			nofollow: true,
			wrap: true,
		}, 'Testimonials From Male BHRT Patients')
	])
}
function ref_b2_7_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b2_7_1'
	}, [
		tb_a_({
			href: 'https://biote.com/women-hormone-imbalance/testimonials',
			nofollow: true,
			wrap: true,
		}, 'Check Out What Some Female Patients Are Saying About Biote!')
	])
}
function ref_b3_3_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b3_3'
	}, [
		tb_a_({
			href: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8025725/',
			nofollow: true,
			wrap: true,
...
function ref_b3_3_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b3_3_1'
	}, [
		tb_a_({
			href: 'https://bmccancer.biomedcentral.com/counter/pdf/10.1186/s12885-019-6457-8.pdf',
			nofollow: true,
			wrap: true,
		}, 'Incidence of invasive breast cancer in women treated with testosterone implants: a prospective 10-year cohort study')
	])
}
function ref_b3_4_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b3_4'
	}, [
		tb_a_({
			href: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8165877/',
			nofollow: true,
			wrap: true,
...
function ref_b4_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_1'
	}, [
		tb_a_({
			href: 'https://biote.com/research/estrogen-brain-structure-and-cognition-in-postmenopausal-women',
			nofollow: true,
			wrap: true,
		}, 'Estrogen, brain structure, and cognition in postmenopausal women')
	])
}
function ref_b4_2_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_2'
	}, [
		tb_a_({
			href: 'https://biote.com/research/in-the-news-covid-reduces-male-sex-hormone-levels',
			nofollow: true,
			wrap: true,
		}, 'In the News: Covid Reduces Male Sex Hormone Levels')
	])
}
function ref_b4_2_1_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_2_1'
	}, [
		tb_a_({
			href: 'https://www.tandfonline.com/doi/full/10.1080/13685538.2020.1807930',
			nofollow: true,
			wrap: true,
...
function ref_b4_3_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_3'
	}, [
		tb_a_({
			href: 'https://biote.com/research/the-effect-of-hormone-therapy-on-the-ocular-surface-and-intraocular-pressure-for-postmenopausal-women',
			nofollow: true,
			wrap: true,
...
/* moot */
// function ref_b4_4_footnote__sup_(ctx:request_ctx_T) {
// 	return footnote__sup_({
// 		ctx,
// 		id: 'b4_4'
// 	}, [
// 		tb_a_({
// 			href: 'https://biote.com/research/correspondence-hormone-therapy-for-postmenopausal-women',
// 			nofollow: true,
// 			wrap: true,
// 		}, 'Correspondence: Hormone Therapy for Postmenopausal Women')
// 	])
// }
function ref_b4_5_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_5'
	}, [
		tb_a_({
			href: 'https://biote.com/research/sub-cutaneous-hormone-pellet-therapy-the-comprehensive-treatment-to-optimize-and-balance-hormones-using-the-biote-method',
			nofollow: true,
			wrap: true,
		}, 'Sub-Cutaneous Hormone Pellet Therapy-The Comprehensive Treatment to Optimize and Balance Hormones Using the BioTE Method')
	])
}
function ref_b4_6_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_6'
	}, [
		tb_a_({
			href: 'https://biote.com/research/testosterone-insufficiency-and-treatment-in-women-international-expert-consensus-resolutions',
			nofollow: true,
			wrap: true,
		}, 'Testosterone Insufficiency and Treatment in Women: International Expert Consensus Resolutions')
	])
}
function ref_b4_7_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_7'
	}, [
		tb_a_({
			href: 'https://biote.com/research/thyroid-disease-a-white-paper-monograph',
			nofollow: true,
			wrap: true,
		}, 'Thyroid Disease-A White Paper Monograph')
	])
}
function ref_b4_8_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_8'
	}, [
		tb_a_({
			href: 'https://biote.com/research/testosterone-in-men-a-review',
			nofollow: true,
			wrap: true,
		}, 'Testosterone in Men: A Review')
	])
}
function ref_b4_9_footnote__sup_(ctx:request_ctx_T) {
	return footnote__sup_({
		ctx,
		id: 'b4_9'
	}, [
		tb_a_({
			href: 'https://biote.com/research/breast-cancer-and-the-hormone-receptor-model-a-white-paper-monograph',
			nofollow: true,
			wrap: true,
