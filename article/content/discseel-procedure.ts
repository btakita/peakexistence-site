...
Developed by Dr. Kevin Pauza, the Discseel® Procedure addresses the root cause of many spine problems. Annular tears in spinal discs. These tears can lead to disc degeneration, herniation, & chronic pain. The procedure utilizes an FDA-approved biologic called Fibrin. Fibrin is naturally found in human blood & used in various medical applications. Including facial reconstruction surgery & controlling cardiac bleeding${ref18_footnote__sup_(ctx)}<!--ref19_footnote__sup_(ctx)-->.
